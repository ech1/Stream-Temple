...
const determineGreet = hours => document.getElementById("greeting").innerText = `void${hours < 12 ? "." : hours < 18 ? "." : "."}${username}`;
...
const search_engines = [{
  ...
  src: "arch.svg",
  placeholder: "Arch Wiki",
  action: "https://wiki.archlinux.org/index.php",
  action2: "?search="
}*/];
